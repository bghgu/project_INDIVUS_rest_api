...
router.get('/', async(req, res) => {
    ...
    if(ID != -1) {
        ...
        for(i = 0 ; i < notice_result.length; i++) {
            ...
            notice_result[i].to_type = notice_result[i].to_type == null ? "" : notice_result[i].to_type;
            notice_result[i].to_id = notice_result[i].to_id == null ? "" : notice_result[i].to_id;
            notice_result[i].from_type = notice_result[i].from_type == null ? "" : notice_result[i].from_type;
            notice_result[i].from_id = notice_result[i].from_id == null ? "" : notice_result[i].from_id;
            //대상이 포스트일 경우
